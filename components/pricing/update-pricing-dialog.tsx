...
export function UpdatePricingDialog({ pricing, open, onOpenChange, onSuccess }: UpdatePricingDialogProps) {
    ...
    async function onSubmit(data: PricingFormValues) {
        ...
        try {
            ...
            toast.success(`Pricing rule updated successfully`, {
                description: `Rule ${data.id} has been updated.`,
            })
            onOpenChange(false)
            onSuccess?.()
        } catch (error) {
    ...
    return (
        <Dialog open={open} onOpenChange={onOpenChange}>
            <DialogContent className="sm:max-w-[425px]">
                <DialogHeader>
                    <DialogTitle>Update Rule {pricing?.id}</DialogTitle>
                    <DialogDescription>
